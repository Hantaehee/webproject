...
public class Facebook{	
	// 자신의 facebook appID
	public static final String APPID = "179854965488472";
	// 자신의 facebook app Secret;
	public static final String APPSECRET = "284c1456d2ed52a7a588d9a6381fe5e8";
	// facebook에 등록시킬 사이트 주소
	public static final SITEURL="http://localhost:8080/webproject/MJU-market";
	...
	public User getCurrentUser() {
		// resfFB��facebookClient瑜��듯� ��� �ъ�����낫瑜�媛����
